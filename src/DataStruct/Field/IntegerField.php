...
class IntegerField extends \CF\DataStruct\Field\DataStructField {
	...
	static function createAndRegister($name, $code = NULL, $label = NULL) {
		$obj = new IntegerField($name, $code, $label);
	...
	/**
	 * @return \CF\DataStruct\Filter\IntegerFilter
	 */
